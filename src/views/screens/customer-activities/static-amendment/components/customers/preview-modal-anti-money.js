...
const PreviewModalAntiMoneyLaundering = ({ showModal, setShowModal }) => {
  ...
  return (
    <Modal show={showModal} size="xl">
      ...
      <Modal.Body>Preview Anti Money Body</Modal.Body>
      <Modal.Footer>
        <Button
...
export default PreviewModalAntiMoneyLaundering;
