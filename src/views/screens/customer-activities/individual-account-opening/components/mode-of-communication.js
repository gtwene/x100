...
function Mode_Of_Communication({data, validationRules,activeStep, formValues, setFormValues, formErrors, setFormErrors, handleClose, handleShow, show_Second}) {
       ...
       {/* First Tab */}
              ...
              <div class="md:w-1/3">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Male">Home Phone Type 1</option>
                    <option value="Female">Home Phone Yype 2</option>
                  </select>
            ...
            <div class="w-full max-w-xl mt-2">
              ...
              <div class="md:w-1/3">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="" >-- Select --</option>
                    <option value="Male">Office Phone Type 1</option>
                    <option value="Female">Office Phone Yype 2</option>
                  </select>
                  <div className="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none">
                    <svg
                      className="h-4 w-4 fill-current text-gray-500"
        ...
        <div className="flex items-center justify-center space-x-20 -mt-3">
            ...
            <div class="w-full max-w-xl mt-2">
              <div className="md:flex md:items-center mb-2 ml-2">
              <div class="md:w-1/3">
                  <Label label="Enable Internet Banking" />
                </div>
                <div className="relative">
                  <select
                    id="select-field"
            ...
            <div class="w-full max-w-xl mt-2">
              <div className="md:flex md:items-center mb-2 ml-2">
              <div class="md:w-1/3">
                  <Label label="Enable Mobile Banking" />
                </div>
                <div className="relative">
                  <select
                    id="select-field"
        ...
        <div className="flex items-center justify-center space-x-20 -mt-3">
            ...
            <div class="w-full max-w-xl mt-2">
              <div className="md:flex md:items-center mb-2 ml-2">
              <div class="md:w-1/3">
                  <Label label="Enable Email Alert" />
                </div>
                <div className="relative">
                  <select
                    id="select-field"
        ...
        <div className="flex items-center justify-center space-x-20 -mt-3">
            ...
            <div class="w-full max-w-xl mt-2">
              <div class="md:flex md:items-center mb-2 ml-2">
                <div class="md:w-1/3">
                  <Label label="Mobile Bank Email " required={true} />
                </div>
                <div className="md:w-2/3 md:mr-2">
                  <input 
                    className="my_inputs" 
