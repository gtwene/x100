...
function Personal_Details({data, validationRules,activeStep, formValues, setFormValues, formErrors, setFormErrors, handleClose, handleShow, show_Second}) {
              ...
              <div class="md:w-1/3">
                ...
                <div className="relative">
                  <select
                    ...
                    className="block appearance-none w-full py-1 pl-3 pr-10 leading-tight rounded-sm border-gray-300 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                  >
