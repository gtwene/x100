...
function Next_Of_King({data, validationRules,activeStep, formValues, setFormValues, formErrors, setFormErrors, handleClose, handleShow, show_Second}) {
       ...
       <div className="flex items-center justify-center space-x-20">
        ...
        <div className="flex items-center justify-center space-x-20 -mt-3">
            ...
            <div class="w-full max-w-xl mt-2">
              <div class="md:flex md:items-center mb-2 ml-2">
                <div class="md:w-1/3">
                  <Label label="Relation Type" required={true} />
                </div>
                <div className="md:w-2/4 ">
                  <ListOfValue 
                    data={data.id_type}
        ...
        <div className="flex items-center justify-center space-x-20 -mt-3">
            ...
            <div class="w-full max-w-xl mt-2">
              <div class="md:flex md:items-center mb-2 ml-2">
                <div class="md:w-1/3">
                  <Label label=" Relation Manager" required={true} />
                </div>
                <div className="md:w-2/4 ">
                  <ListOfValue 
                    data={data.id_type}
