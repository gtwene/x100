...
export default function UserCreation() {
  ...
  return (
    <>
      <div className="p-3" style={{ zoom: "0.9", marginBottom: "-40px", marginTop: "-15px" }}>
        ...
        <div style={{ marginTop: "-15px", textAlign: "center", zoom: "0.85" }}>
          ...
          <span style={{ paddingLeft: 5, paddingRight: 5 }}>
          <button id="saveBTN" className='btn btn-secondary' onClick={() => handleSubmit()} style={{ background: `url(` + window.location.origin + `/assets/images/headerBackground/` + headerImage + `)` }}><MDBIcon style={{ color: "white", marginLeft: "10px", paddingBottom: 5, fontSize: 15 }} fas icon="save" /><br />Submit</button>
          </span>
          ...
          <span style={{ paddingLeft: 5, paddingRight: 5 }}>
          <button className='btn btn-secondary' onClick={() => document.getElementById("closeModalBTN").click()} style={{ background: `url(` + window.location.origin + `/assets/images/headerBackground/` + headerImage + `)` }}><MDBIcon style={{ color: "white", marginLeft: "10px", paddingBottom: 5, fontSize: 15 }} fas icon="sign-out-alt" /><br />Exit</button>
          </span>
