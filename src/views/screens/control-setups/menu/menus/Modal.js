    ...
    <>
      ...
      >
        ...
        <Modal.Body style={{ background: "white" }}>
          {type === "previewSub" && (
            <DataTable title={<span style={{ fontSize: "15px", textTransform: "uppercase" }}>SUB MENUS OF <b>{name}</b></span>} data={arr} dataProcessingInfo={dataProcessingInfo} columns={columns} />
          )}
          {type === "edit" && (
            <FormLayout
