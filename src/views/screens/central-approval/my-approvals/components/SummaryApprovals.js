...
function SummaryApproval({ title, dataProcessingInfo, rowsPerPage, tableCellFontSize }) {
  const options = { selectableRows: "none", rowsPerPage: 5, textLabels: {
    ...
    const getMuiTheme = () => createTheme({
      ...
      let data = [ 
        [1, "Account Mandate / Image Amendment", 1, <div className="flex space-x-3">
        <button
        ...
        [2, "Approve Batch Transactions", 3, <div className="flex space-x-3">
        <button
          style={{ fontSize: "15px", color: "white", background: `url(` + window.location.origin + `/assets/images/headerBackground/` + headerImage + `)` }}
          onClick={function (e) { e.preventDefault(); setPreviewPendingApprovals(!showPreviewPendingApprovals); }}
          className="hover:scale-110 transition transform ease-in-out bg-red-700  px-2 py-1 rounded-sm text-center text-white"
        ...
        [3, "Cheque Approval", 5, <div className="flex space-x-3">
        <button
          style={{ fontSize: "15px", color: "white", background: `url(` + window.location.origin + `/assets/images/headerBackground/` + headerImage + `)` }}
          onClick={function (e) { e.preventDefault(); setPreviewPendingApprovals(!showPreviewPendingApprovals); }}
          className="hover:scale-110 transition transform ease-in-out bg-red-700  px-2 py-1 rounded-sm text-center text-white"
        ...
        [4, "Cheque Book Requisition", 4, <div className="flex space-x-3">
        <button
          style={{ fontSize: "15px", color: "white", background: `url(` + window.location.origin + `/assets/images/headerBackground/` + headerImage + `)` }}
          onClick={function (e) { e.preventDefault(); setPreviewPendingApprovals(!showPreviewPendingApprovals); }}
          className="hover:scale-110 transition transform ease-in-out bg-red-700  px-2 py-1 rounded-sm text-center text-white"
        ...
        [5, "Collateral Creation", 8, <div className="flex space-x-3">
        <button
          style={{ fontSize: "15px", color: "white", background: `url(` + window.location.origin + `/assets/images/headerBackground/` + headerImage + `)` }}
          onClick={function (e) { e.preventDefault(); setPreviewPendingApprovals(!showPreviewPendingApprovals); }}
          className="hover:scale-110 transition transform ease-in-out bg-red-700  px-2 py-1 rounded-sm text-center text-white"
        ...
        [6, "Credit Approval", 3, <div className="flex space-x-3">
        <button
          style={{ fontSize: "15px", color: "white", background: `url(` + window.location.origin + `/assets/images/headerBackground/` + headerImage + `)` }}
          onClick={function (e) { e.preventDefault(); setPreviewPendingApprovals(!showPreviewPendingApprovals); }}
          className="hover:scale-110 transition transform ease-in-out bg-red-700  px-2 py-1 rounded-sm text-center text-white"
        ...
        [7, "Credit Disbursement Approval", 3, <div className="flex space-x-3">
        <button
          style={{ fontSize: "15px", color: "white", background: `url(` + window.location.origin + `/assets/images/headerBackground/` + headerImage + `)` }}
          onClick={function (e) { e.preventDefault(); setPreviewPendingApprovals(!showPreviewPendingApprovals); }}
          className="hover:scale-110 transition transform ease-in-out bg-red-700  px-2 py-1 rounded-sm text-center text-white"
        ...
        [8, "Credit Origination Approval", 3, <div className="flex space-x-3">
        <button
          style={{ fontSize: "15px", color: "white", background: `url(` + window.location.origin + `/assets/images/headerBackground/` + headerImage + `)` }}
          onClick={function (e) { e.preventDefault(); setPreviewPendingApprovals(!showPreviewPendingApprovals); }}
          className="hover:scale-110 transition transform ease-in-out bg-red-700  px-2 py-1 rounded-sm text-center text-white"
