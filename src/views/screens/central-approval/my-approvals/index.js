...
const MyApprovals = () => {
  ...
  return (
    <div>
          ...
          <span style={{ paddingLeft: 5, paddingRight: 5 }}>
          <button className='btn btn-primary' onClick={function (e) { e.preventDefault(); setMyApprovalLimit(!showMyApprovalLimit); }} style={{ background: `url(` + window.location.origin + `/assets/images/headerBackground/` + getTheme.theme.headerImage + `)` }}><MDBIcon style={{ color: "white", marginLeft: "10px", paddingBottom: 5, fontSize: 15 }} fas icon="align-center" /><br />App. Limit</button>
          </span>
