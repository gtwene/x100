...
const ModernMainLayout = () => {
    ...
    return (
      <>
        {/* <SimpleGrid
          cols={4}
          className="ml-4 mr-4 mb-6 modernLayoutC mozMainContentsModern"
          spacing="lg"
          style={{ zoom: 0.9, marginTop: "0px", marginRight: "29px" }}
          breakpoints={[
      ...
      <div style={{ zoom: 0.9, marginTop: "0px", marginRight: "29px" }} className="flex justify-center ml-4 mb-6 modernLayoutCC modernLayoutC  mozMainContentsModern">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">

          <div className="ccard ccardModern">
            <Card
        ...
        <SimpleGrid
          ...
          className="ml-4 mr-4 mb-6 modernLayoutC mozMainContentsModern"
          spacing="lg"
          style={{ zoom: 0.9, marginTop: "-23px", marginRight: "29px" }}
          // breakpoints={[
          //   { maxWidth: 980, cols: 3, spacing: "md" },
          //   { maxWidth: 755, cols: 2, spacing: "sm" },
          //   { maxWidth: 600, cols: 1, spacing: "sm" },
        ...
        >
          ...
          <DataTable
            id="systemAuditLogsModern"
            name="systemAuditLogsModern"
            tile=""
